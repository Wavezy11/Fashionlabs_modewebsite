                  ...
                  {activeTab === "photos" && (
                    <div>
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <Link href="/dashboard/photos/new" className="bg-[#9480AB] text-white px-3 py-1 rounded text-sm">
                          + Upload
                        </Link>
                      </div>
                        ...
                        {photos.map((photo) => (
                          <div key={photo.id} className="border border-gray-200 rounded-md overflow-hidden">
                            <div className="aspect-square bg-gray-100 relative">
                              ...
                              />
                              <div className="absolute bottom-0 right-0 bg-white px-2 py-1 text-sm">{photo.likes} ❤️</div>
                            </div>
                            <div className="p-2">
                  ...
                  {activeTab === "events" && (
                    <div>
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <Link href="/dashboard/events/new" className="bg-[#9480AB] text-white px-3 py-1 rounded text-sm">
                          + Nieuw
                        </Link>
                      </div>
