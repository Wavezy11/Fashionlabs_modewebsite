  ...
  const people = [
    {
      id: "brandon",
      name: "Brandon",
      image: "/placeholder.svg?height=200&width=300&text=Brandon",
      description:
    ...
    },
    {
      id: "sarah",
      name: "Sarah",
      image: "/placeholder.svg?height=200&width=300&text=Sarah",
      description:
    ...
    },
    {
      id: "mike",
      name: "Mike",
      image: "/placeholder.svg?height=200&width=300&text=Mike",
      description:
          ...
          <div className="screen h-full w-full overflow-y-auto pt-[30px] relative">
            ...
            <div className="relative w-full">
              ...
              <div className="bg-white text-center py-4">
                <h1 className="text-2xl font-bold text-black">Graduation Show</h1>
              </div>

              {/* Main Image */}
              <div className="relative w-full">
                <Image
                  src="/placeholder.svg?height=300&width=390&text=Graduation+Show+Image"
                  alt="Graduation Show"
                  width={390}
                  height={300}
              ...
              <div className="bg-[#9480AB] px-6 py-8">
                ...
                <div className="space-y-8">
                  {people.map((person) => (
                    <div key={person.id} className="bg-white rounded-lg p-6 shadow-lg">
                      <h3 className="text-2xl font-bold text-[#9480AB] mb-4 text-center">{person.name}</h3>
                      <div className="mb-4">
                        <Image
