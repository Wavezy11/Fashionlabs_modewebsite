...
export default function ModeshowPage() {
        ...
        <div className="h-full pt-[30px] overflow-y-auto overflow-x-hidden">
          ...
          <main className="bg-white">
            ...
            <div className="px-8 py-6">
              <h1 className="text-2xl font-bold mb-1">DIGITAL FASHION</h1>
              <h2 className="text-2xl font-bold">MODESHOW</h2>
            </div>
            ...
            <div className="px-8 pb-6">
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center">
                  <div className="flex items-center justify-center w-10 h-10 mr-4">
                    <span className="text-2xl font-bold">{standingTickets}</span>
                    <span className="text-xl font-bold">+</span>
                  </div>
                  <div>
                    <p className="font-bold">Staanplaatsen</p>
                    <p>€ 10,- per stuk</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <button
                    ...
                    className="w-8 h-8 bg-[#9480AB] text-white font-bold text-xl flex items-center justify-center rounded-full"
                  >
                    -
                  </button>
                  <button
                    onClick={() => incrementTickets("standing")}
                    className="w-8 h-8 bg-[#9480AB] text-white font-bold text-xl flex items-center justify-center rounded-full ml-2"
                  >
                    +
                  </button>
                </div>
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center">
                  <div className="flex items-center justify-center w-10 h-10 mr-4">
                    <span className="text-2xl font-bold">{wheelchairTickets}</span>
                    <span className="text-xl font-bold">+</span>
                  </div>
                  <div>
                    <p className="font-bold">Rolstoelplaatsen</p>
                    <p>€ 10,- per stuk</p>
                  </div>
                </div>
                <div className="flex items-center">
              ...
              <div className="text-sm text-gray-600 mb-8">
                <p>Prijzen inclusief 3,10 servicekosten.</p>
                <p>
              ...
              <div className="flex justify-center">
                <button className="bg-black text-white px-12 py-4 text-lg font-bold tracking-wide hover:bg-gray-800 transition-colors">
                  DOORGAAN
                </button>
              </div>
            </div>
